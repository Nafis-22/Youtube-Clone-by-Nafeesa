...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=popular%20videos&key=AIzaSyC4IzFYxUzmfJ8TtDJFL77ILA_dsvrq8xM&maxResults=25`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyC4IzFYxUzmfJ8TtDJFL77ILA_dsvrq8xM&maxResults=25`);
let data = await res.json();
